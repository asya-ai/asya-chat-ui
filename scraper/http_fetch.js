/**
 * User-Agent for Node `fetch` only.
 *
 * Do not claim Chrome here: Node's TLS fingerprint is not Chrome, and CDNs
 * like SiteGround return 403 when a Chrome UA is paired with non-Chrome TLS.
 * The Puppeteer path uses the launched browser's real Chrome identity instead.
 */
export const HTTP_FETCH_USER_AGENT =
...
const DEFAULT_FETCH_HEADERS = {
  "User-Agent": HTTP_FETCH_USER_AGENT,
